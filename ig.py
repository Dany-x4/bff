...
def menu_dev():
	...
	print baner
	print k+" >_"+h+" Author:"+k+" DANZZ X NANO"
# print k+" >_"+h+#" Coding:"+k+#" Python27"
	...
	try:
		...
		print belum_premium
	print garis
	print a+" ["+k+"1"+a+"] "+p+"Hack dari followers Publik "+k+"{"+a+"Rusak ber lisensi:v"+k+"}"
	print a+" ["+k+"2"+a+"] "+p+"Hack dari Pencarian Orang"
	print a+" ["+k+"3"+a+"] "+p+"Haack Target"
	print a+" ["+k+"4"+a+"] "+p+"Cek hasil"+h+" OK"+a+"/"+k+"CP"
	print a+" ["+k+"5"+a+"] "+p+"Tambah Followers ig"
